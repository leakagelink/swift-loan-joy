  ...
  head: () => ({
    meta: [
      { title: "Partner Login — Business Standard Loan" },
      {
        name: "description",
        content:
          "Secure OTP and password login for Business Standard Loan DSA partners and relationship managers.",
      },
...
function LoginPage() {
  ...
  return (
    <AuthLayout
      title="Welcome back"
      subtitle="Login to manage your leads, file logins, payouts and disbursements."
    >
